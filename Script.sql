...
SELECT DIRECTOR_NAME, 2024 - YEAR(DIRECTOR_BIRTH_DATE) AS edadDirector FROM DIRECTORS 
WHERE DIRECTOR_BIRTH_DATE BETWEEN '1974-01-01' AND CURRENT_DATE 
AND DIRECTOR_DEAD_DATE IS NULL;

--10. Devuelve el nombre y la edad de todos los actores menores de 50 años que hayan fallecido

SELECT ACTOR_NAME, 2024 - YEAR(ACTOR_BIRTH_DATE) AS edadActor  FROM ACTORS WHERE ACTOR_BIRTH_DATE 
